    ...
    return(
        <div className='main'>
            <div className='mainDiv'>
                ...
                <p>
                    This app is intended to be a starter/tutorial app for your upcoming project and a learning sandbox for 
                    you in months and years to come should you continue to develope software with React.  In this application, 
                    we will work through some of the basic React concepts, build out some small applications, and then unleash 
                ...
                <ul>
                    ...
                    <li>The set up fpr this app might be the most confusing part.  Hang in there!</li>
                    <li>
